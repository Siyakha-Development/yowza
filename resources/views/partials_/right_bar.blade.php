        ...
        >
            <div class="flex items-center justify-between py-2 px-4">
                ...
                >
                    ...
                    <span id="currentDate" class="text-xs"></span>
                </p>
                <p
                        ...
                        <div class="swiper-wrapper">
                            ...
                            >
                                <div class="grow">
                                    <img
                                        class="h-3"
                                        src="{{asset('backend/images/payments/cc-visa-white.svg')}}"
                                        alt="image"
                                    />
                                </div>
                                <div class="text-white">
                    ...
                    <div class="mt-3 grid grid-cols-2 gap-3 px-3">
                        <div class="rounded-lg bg-slate-100 p-2.5 dark:bg-navy-600">
                            <div class="flex items-center space-x-2">
                                <img
                                    class="size-10"
                                    src="{{asset('backend/images/logos/bitcoin.svg')}}"
                                    alt="image"
                                />
                                <div>
                                    <h2
                        ...
                        <div class="rounded-lg bg-slate-100 p-2.5 dark:bg-navy-600">
                            <div class="flex items-center space-x-2">
                                <img
                                    class="size-10"
                                    src="{{asset('backend/images/logos/solana.svg')}}"
                                    alt="image"
                                />
                                <div>
                                    <h2
                ...
                <div class="mt-4">
                    ...
                    <div class="mt-3 space-y-3 px-2">
                        ...
                        >
                            ...
                            <img
                                src="{{asset('backend/images/object/object-18.jpg')}}"
                        ...
                        >
                            ...
                            <img
                                src="{{asset('backend/images/object/object-2.jpg')}}"
                                class="size-20 rounded-lg object-cover object-center"
                                alt="image"
                            />
                        </div>
                        ...
                        >
                            ...
                            <img
                                src="{{asset('backend/images/object/object-1.jpg')}}"
                                class="size-20 rounded-lg object-cover object-center"
                                alt="image"
                            />
                        </div>
...
<script>
    ...
    // Function to render the current date in the format "Month YYYY"
