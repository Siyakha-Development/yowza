...
<!-- Mirrored from lineone.piniastudio.com/apps-chat.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 28 Mar 2024 14:30:45 GMT -->
...
<!--sidebar-->
      @include('partials_.aichat.aichat_sidebar')
    </div>

    <!-- Right Sidebar -->
    @include('partials_.aichat.ai_chat_right_bar')

    <!-- Main Content Wrapper -->
    <main
        x-data="{isShowChatInfo : !$store.breakpoints.mdAndDown ,activeChat:{chatId:'chat-1',name:'Alfredo Elliott',avatar_url:'images/avatar/avatar-19.jpg'}}"
...
<!-- Mirrored from lineone.piniastudio.com/apps-chat.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 28 Mar 2024 14:30:46 GMT -->
</html>
