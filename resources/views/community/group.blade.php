...
<div class="2xl:max-w-[1220px] max-w-[1065px] mx-auto">
    ...
    <div class="page-heading">
        ...
        <nav class="nav__underline">
            ...
            <ul class="group" uk-switcher="connect: #group-tabs ; animation: uk-animation-slide-right-medium, uk-animation-slide-left-medium">
                ...
                <li> <a href="#" aria-expanded="false"> My groups </a> </li>
    ...
    <!-- group list tabs -->
    <div class="uk-switcher" id="group-tabs" style="touch-action: pan-y pinch-zoom;">
            ...
            <div class="card">
                <a href="">
                    <div class="card-media h-24">
                        ...
                        <img src="{{ Storage::url($group->group_banner) }}" alt="">
                ...
                <div class="card-body">
                    ...
                    <div class="flex gap-2">
                        <form action="{{ route('smme.groups.join', ['prefix' => 'admin', $group->id]) }}" method="POST" style="display:inline;">
                            @csrf
                            <button type="submit" style="color:white;" class="button bg-primary-soft text-primary dark:text-white gap-1 max-md:hidden">Join</button>
                        </form>
                        <a href="{{ route('smme.yowza-community-groups.show', ['prefix' => 'admin', $group->id]) }}" class="button bg-secondery !w-auto"> View</a>
                    </div>
                </div>
            </div>
            @endforeach
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="card-text">
                        ...
                        <div class="flex items-center gap-3 mt-3">
                            <div class="flex -space-x-2">
                                <img src="assets/images/avatars/avatar-4.jpg" alt="" class="w-6 rounded-full border-2 border-white dark:border-slate-800">
                                <img src="assets/images/avatars/avatar-3.jpg" alt="" class="w-6 rounded-full border-2 border-white dark:border-slate-800">
                                <img src="assets/images/avatars/avatar-7.jpg" alt="" class="w-6 rounded-full border-2 border-white dark:border-slate-800">
                            </div>
    ...
    <div tabindex="-1" uk-slider="finite:true" class="uk-slider">
        ...
        <div class="uk-slider-container pb-1">
            ...
            <ul class="uk-slider-items grid-small" style="transform: translate3d(0px, 0px, 0px);">

                <li class="md:w-1/5 sm:w-1/3 w-1/2 uk-active" tabindex="-1">
                    <a href="#">
        ...
        <!-- slide nav icons -->
        <a class="nav-prev uk-invisible" href="#" uk-slider-item="previous">
    ...
    <div class="grid md:grid-cols-2 md:gap-2 gap-3">
        ...
        <div class="flex md:items-center space-x-4 p-4 rounded-md box">
            ...
            <button type="button" class="button bg-primary-soft text-primary dark:text-white gap-1 max-md:hidden" style="color: white;">
                <ion-icon name="add-circle" class="text-xl -ml-1 md hydrated" role="img" aria-label="add circle"></ion-icon> Join
            </button>
