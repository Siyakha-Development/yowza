                                    ...
                                    <div x-ref="popperRoot" class="popper-root" :class="isShowPopper &amp;&amp; 'show'" style="position: fixed; inset: 0px 0px auto auto; margin: 0px; transform: translate(-151px, 281px);" data-popper-placement="bottom-end">
                                        <div class="popper-box rounded-md border border-slate-150 bg-white py-1.5 font-inter dark:border-navy-500 dark:bg-navy-700">
                                            <ul>
                                                ...
                                                <li>
                                                    <form action="{{ route('admin.courses.restore', ['prefix' => 'admin', 'course' => $course->id]) }}" method="POST" onsubmit="return confirm('Are you sure ?');" style="display: inline-block;">
                                                        @csrf
                                                ...
                                                <li>
                                                    <form action="{{ route('admin.courses.perma_del', ['prefix' => 'admin', 'course' => $course->id]) }}" method="POST" onsubmit="return confirm('Are you sure ?');" style="display: inline-block;">
                                                        @csrf
                                                        @method('delete')
